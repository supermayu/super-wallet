...
export interface SuperWalletFactoryInterface extends Interface {
  getFunction(
...
export interface SuperWalletFactory extends BaseContract {
  connect(runner?: ContractRunner | null): SuperWalletFactory;
  waitForDeployment(): Promise<this>;

  interface: SuperWalletFactoryInterface;
